    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs" id="myTab2" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link <?=$this->session->userdata('user_level')!=1 ? 'disabled':''?>" id="profile-tab2" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile" aria-selected="false">Sistem</a>
          </li>
        </ul>
        <div class="tab-content tab-bordered" id="myTab3Content">
          <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home-tab2">
            <table border="0px">
              <tr>
                <td>
                  <img calss="text-center" src="<?=base_url()?>assets/img/rlthsleman.jpeg" width="160px" height="160px" style="margin:5px">
                </td>
                <td>
                  <h3>Selamat Datang</h3>
                  <p>
                    Aplikasi Pendataan Permohonan Bantuan Perumahan, Kabupaten Sleman<br /><?='Tanggal '.date('d-m-Y')?>
                  </p>
                  <p>
                    Aplikasi Versi : 1.0
                  </p>
