<?php
	function buttonaksi($aksi,$id,$segmenturi){
		...
		if(isset($aksi['cetak'])&&$aksi['cetak']){
			echo'
			<a href="'.base_url($aksi['url']."/cetakpdfbyid/".$id).'"  target="_blank" data-toggle="tooltip" title="" class="cetak btn btn-icon btn-primary btn-md" data-original-title="Cetak PDF" >
