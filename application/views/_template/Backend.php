        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <?php if($this->session->userdata('user_level')!=1 AND $this->session->userdata('user_level')!=2):?>
                  <a href="<?=site_url('Login/Loginpemohon/logout')?>" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <img src="<?=base_url()?>assets/img/rlthsleman.jpeg" width="80px" height="85px" style="margin:5px">
            <!-- <a href="<?= base_url()?>" > <?= $this->session->userdata('sistem') ? $this->session->userdata('sistem'): $setting['sistem']?> </a> -->
          </div>
